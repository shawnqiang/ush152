		...
		<div id="layout_settings" class="divtab">
			...
			<table class="form">
				...
				<tr>
					...
					<td>
						<input type="checkbox" name="sellegance_display_shadows"<?php if ($sellegance_display_shadows) echo 'checked="checked"';?>>
		...
		<div id="functions_settings" class="divtab">
			...
			<table class="form">
				...
				<tr>
					...
					<td>
						<input type="checkbox" name="sellegance_cloud_zoom"<?php if ($sellegance_cloud_zoom) echo 'checked="checked"';?>>
		...
		<div id="footer_settings" class="divtab">
			...
			<table class="form">
				...
				<tr>
					...
					<td>
						<input type="text" name="sellegance_facebook_id" value="<?php echo $sellegance_facebook_id; ?>" /></td>
				</tr>
