	...
	$('#button-shipping-method').live('click', function() {
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['error']) {
					if (json['error']['warning']) {
						$('#shipping-method .checkout-content').prepend('<div class="alert warning" style="display: none;">' + json['error']['warning'] + '</div>');
	...
	$('#button-payment-method').live('click', function() {
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['error']) {
					if (json['error']['warning']) {
						$('#payment-method .checkout-content').prepend('<div class="alert warning" style="display: none;">' + json['error']['warning'] + '</div>');
