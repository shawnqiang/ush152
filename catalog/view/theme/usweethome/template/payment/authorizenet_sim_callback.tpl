...
<div class="buttons">
	<table>
		<tr>
			<td align="left"></td>
			<td align="right"><a onclick="location = '<?php echo $confirm; ?>'" class="btn"><span><?php echo $button_confirm; ?></span></a></td>
		</tr>
	</table>
</div>
...
<div class="buttons">
	<table>
		<tr>
			<td align="left"><a onclick="location = '<?php echo $back; ?>'" class="btn"><span><?php echo $button_back; ?></span></a></td>
			<td align="right"></td>
		</tr>
	</table>
</div>
...
<div class="buttons">
	<table>
		<tr>
			<td align="left"><a onclick="location = '<?php echo $back; ?>'" class="btn btn-cart"><span><?php echo $button_back; ?></span></a></td>
			<td align="right"></td>
		</tr>
	</table>
</div>
