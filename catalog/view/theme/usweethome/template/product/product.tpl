		...
		<div class="row-fluid">
			...
			<div class="span6">
				...
				<?php if ($thumb) { ?>
					...
					<?php if($this->config->get('usweethome_status')== 1 && $this->config->get('usweethome_cloud_zoom')!='') { ?>
			...
			<div class="span6">
				...
				<?php if ($review_status) { ?>
					...
					<div class="review">
						...
						<img src="catalog/view/theme/usweethome/images/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
				...
				<script type="text/javascript">
					...
					new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
						...
						onSubmit: function(file, extension) {
							$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/usweethome/images/loading.gif" class="loading" style="padding-left: 5px;" />');
						},
		...
		$('#button-review').bind('click', function() {
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#review-title').after('<div class="alert attention"><img src="catalog/view/theme/usweethome/images/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
				},
				complete: function() {
