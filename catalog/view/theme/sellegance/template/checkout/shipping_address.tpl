<div class="span6 offset3">
	...
	<div id="shipping-new" style="display: none;">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select name="country_id" onchange="$('#shipping-address select[name=\'zone_id\']').load('index.php?route=checkout/shipping_address/zone&country_id=' + this.value);" class="span6" >
